...
cd ~/temp/sapOut/html_private_cloud
unset LANG
...
sed -i '' 's/src="\/sites\/docs\/files/src="..\/html\/sites\/docs\/files/g' *.html
sed -i '' 's/src="\/docs\/sites\/docs\/files/src="..\/html\/sites\/docs\/files/g' *.html
grep "\[node:" *.html
grep "\[\[nid:" *.html
grep "src=\"\/sites" *.html
grep "src=\"\/docs" *.html
